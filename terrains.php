...
// Récupérer les produits de la catégorie "Terrains" depuis la base de données
$sql = "SELECT * FROM products WHERE category = 'Terrains'";
...
<head>
    ...
    <title>Terrains | OUEST DEAL</title>
...
<body>
    <div class="container">
        <header class="header">
            <h1>Nos Terrains</h1>
            <p>Découvrez nos meilleures offres de terrains du moment</p>
        </header>

...
// Récupérer les produits de la catégorie "Electronique" depuis la base de données
$sql = "SELECT * FROM products WHERE category = 'Electronique'";
...
<head>
    ...
    <title>Electronique | OUEST DEAL</title>
...
<body>
    <div class="container">
        <header class="header">
            <h1>Nos Produits Électroniques</h1>
            <p>Découvrez nos meilleures offres d'électronique du moment</p>
        </header>
        ...
        <div class="product-grid">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<p>Aucun produit électronique trouvé.</p>";
            }
            ?>
        </div>
    </div>

...
// Récupérer les produits de la catégorie "Véhicules" depuis la base de données
$sql = "SELECT * FROM products WHERE category = 'Véhicules'";
...
<head>
    ...
    <title>Véhicules | OUEST DEAL</title>
...
<body>
    <div class="container">
        <header class="header">
            <h1>Nos Véhicules</h1>
            <p>Découvrez nos meilleures offres de véhicules du moment</p>
        </header>

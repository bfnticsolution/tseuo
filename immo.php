...
// Récupérer les produits immobiliers depuis la base de données
$sql = "SELECT * FROM products WHERE category = 'Immobilier'";
...
<body>
    <div class="container">
        <header class="header">
            ...
            <p>Découvrez nos meilleures offres immobilières du moment</p>
        </header>
        ...
        <div class="product-grid">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<p>Aucun produit immobilier trouvé.</p>";
            }
            ?>
        </div>
    </div>
